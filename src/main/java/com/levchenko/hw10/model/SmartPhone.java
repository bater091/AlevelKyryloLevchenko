...
public class SmartPhone extends Phone implements PhoneActions {
    public SmartPhone(int number, int series, int charge, PhoneTrouble phoneTrouble) {
    ...
    public boolean allMethod() {
        return call(123) && charge() && photo() && selfie();
    }
